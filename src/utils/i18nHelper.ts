...
export const VERB_DICTIONARY: Record<SupportedLocale, VerbDictionaryEntry> = {
  en: { convert: "Convert", compress: "Compress", merge: "Merge", split: "Split", rotate: "Rotate", crop: "Crop", resize: "Resize", extract: "Extract", to: "to", from: "from", onlineFree: "Online Free", privacyNotice: "Private, local-first file processing directly in your browser." },
  es: { convert: "Convertir", compress: "Comprimir", merge: "Unir", split: "Dividir", rotate: "Rotar", crop: "Recortar", resize: "Redimensionar", extract: "Extraer", to: "a", from: "desde", onlineFree: "Online Gratis", privacyNotice: "Procesamiento de archivos privado y local directamente en tu navegador." },
  "es-419": { convert: "Convertir", compress: "Comprimir", merge: "Unir", split: "Dividir", rotate: "Rotar", crop: "Recortar", resize: "Redimensionar", extract: "Extraer", to: "a", from: "desde", onlineFree: "Gratis en Línea", privacyNotice: "Procesamiento de archivos privado y local directamente en tu navegador." },
  de: { convert: "Konvertieren", compress: "Komprimieren", merge: "Zusammenfügen", split: "Trennen", rotate: "Drehen", crop: "Zuschneiden", resize: "Größe ändern", extract: "Extrahieren", to: "in", from: "von", onlineFree: "Kostenlos Online", privacyNotice: "Private, lokale Dateiverarbeitung direkt in Ihrem Browser." },
  fr: { convert: "Convertir", compress: "Compresser", merge: "Fusionner", split: "Diviser", rotate: "Faire pivoter", crop: "Rogner", resize: "Redimensionner", extract: "Extraire", to: "en", from: "de", onlineFree: "Gratuit en Ligne", privacyNotice: "Traitement de fichiers privé et local directement dans votre navigateur." },
  pt: { convert: "Converter", compress: "Comprimir", merge: "Juntar", split: "Dividir", rotate: "Girar", crop: "Cortar", resize: "Redimensionar", extract: "Extrair", to: "para", from: "de", onlineFree: "Grátis Online", privacyNotice: "Processamento de ficheiros privado e local diretamente no seu navegador." },
  "pt-BR": { convert: "Converter", compress: "Comprimir", merge: "Juntar", split: "Dividir", rotate: "Girar", crop: "Cortar", resize: "Redimensionar", extract: "Extrair", to: "para", from: "de", onlineFree: "Grátis Online", privacyNotice: "Processamento de arquivos privado e local diretamente no seu navegador." },
  it: { convert: "Converti", compress: "Comprimi", merge: "Unisci", split: "Dividi", rotate: "Ruota", crop: "Ritaglia", resize: "Ridimensiona", extract: "Estrai", to: "in", from: "da", onlineFree: "Gratis Online", privacyNotice: "Elaborazione file privata e locale direttamente nel browser." },
  nl: { convert: "Converteren", compress: "Comprimeren", merge: "Samenvoegen", split: "Splitsen", rotate: "Draaien", crop: "Bijsnijden", resize: "Formaat wijzigen", extract: "Uittrekken", to: "naar", from: "van", onlineFree: "Gratis Online", privacyNotice: "Privé, lokale bestandsverwerking direct in uw browser." },
  ca: { convert: "Convertir", compress: "Comprimir", merge: "Unir", split: "Dividir", rotate: "Girar", crop: "Retallar", resize: "Redimensionar", extract: "Extreure", to: "a", from: "de", onlineFree: "Online Gratuït", privacyNotice: "Processament de fitxers privat i local directament al navegador." },
  sv: { convert: "Konvertera", compress: "Komprimera", merge: "Slå samman", split: "Dela upp", rotate: "Rotera", crop: "Beskär", resize: "Ändra storlek", extract: "Extrahera", to: "till", from: "från", onlineFree: "Gratis Online", privacyNotice: "Privat, lokal filbearbetning direkt i webbläsaren." },
  da: { convert: "Konverter", compress: "Komprimer", merge: "Sammenføj", split: "Opdel", rotate: "Roter", crop: "Beskær", resize: "Tilpas størrelse", extract: "Udpak", to: "til", from: "fra", onlineFree: "Gratis Online", privacyNotice: "Privat, lokal filbehandling direkte i browseren." },
  fi: { convert: "Muunna", compress: "Pakkaa", merge: "Yhdistä", split: "Jaa", rotate: "Käännä", crop: "Rajaa", resize: "Muuta kokoa", extract: "Pura", to: "muotoon", from: "muodosta", onlineFree: "Ilmaiseksi Verkossa", privacyNotice: "Yksityinen, paikallinen tiedostojen käsittely suoraan selaimessasi." },
  no: { convert: "Konverter", compress: "Komprimer", merge: "Slå sammen", split: "Del opp", rotate: "Roter", crop: "Beskjær", resize: "Endre størrelse", extract: "Pakk ut", to: "til", from: "fra", onlineFree: "Gratis på Nett", privacyNotice: "Privat, lokal filbehandling direkte i nettleseren." },
  pl: { convert: "Konwertuj", compress: "Kompresuj", merge: "Połącz", split: "Podziel", rotate: "Obróć", crop: "Przytnij", resize: "Zmień rozmiar", extract: "Wyodrębnij", to: "na", from: "z", onlineFree: "Za Darmo Online", privacyNotice: "Prywatne, lokalne przetwarzanie plików bezpośrednio w przeglądarce." },
  cs: { convert: "Převést", compress: "Komprimovat", merge: "Sloučit", split: "Rozdělit", rotate: "Otočit", crop: "Oříznout", resize: "Změnit velikost", extract: "Extrahovat", to: "do", from: "z", onlineFree: "Zdarma Online", privacyNotice: "Soukromé, místní zpracování souborů přímo v prohlížeči." },
  hu: { convert: "Konvertálás", compress: "Tömörítés", merge: "Egyesítés", split: "Szétválasztás", rotate: "Forgatás", crop: "Körülvágás", resize: "Átméretezés", extract: "Kibontás", to: "formátumba", from: "formátumból", onlineFree: "Ingyen Online", privacyNotice: "Privát, helyi fájlfeldolgozás közvetlenül a böngészőben." },
  ro: { convert: "Convertește", compress: "Comprimă", merge: "Îmbină", split: "Împarte", rotate: "Rotește", crop: "Decupează", resize: "Redimensionează", extract: "Extrage", to: "în", from: "din", onlineFree: "Gratuit Online", privacyNotice: "Procesare privată și locală a fișierelor direct în browser." },
  bg: { convert: "Конвертиране", compress: "Компресиране", merge: "Обединяване", split: "Разделяне", rotate: "Завъртане", crop: "Изрязване", resize: "Преоразмеряване", extract: "Извличане", to: "в", from: "от", onlineFree: "Безплатно Онлайн", privacyNotice: "Сигурна, локална обработка на файлове директно в браузъра." },
  el: { convert: "Μετατροπή", compress: "Συμπίεση", merge: "Συγχώνευση", split: "Διαχωρισμός", rotate: "Περιστροφή", crop: "Περικοπή", resize: "Αλλαγή μεγέθους", extract: "Εξαγωγή", to: "σε", from: "από", onlineFree: "Δωρεάν Online", privacyNotice: "Ιδιωτική, τοπική επεξεργασία αρχείων απευθείας στο πρόγραμμα περιήγησης." },
  sk: { convert: "Konvertovať", compress: "Komprimovať", merge: "Zlúčiť", split: "Rozdeliť", rotate: "Otočiť", crop: "Orezať", resize: "Zmeniť veľkosť", extract: "Extrahovať", to: "do", from: "z", onlineFree: "Zadarmo Online", privacyNotice: "Súkromné, lokálne spracovanie súborov priamo v prehliadači." },
  sl: { convert: "Pretvori", compress: "Stisni", merge: "Združi", split: "Razdeli", rotate: "Zavrti", crop: "Obreži", resize: "Spremeni velikost", extract: "Izvozi", to: "v", from: "iz", onlineFree: "Brezplačno na Spletu", privacyNotice: "Zasebna, lokalna obdelava datotek neposredno v brskalniku." },
  ru: { convert: "Конвертировать", compress: "Сжать", merge: "Объединить", split: "Разделить", rotate: "Повернуть", crop: "Обрезать", resize: "Изменить размер", extract: "Извлечь", to: "в", from: "из", onlineFree: "Бесплатно Онлайн", privacyNotice: "Конфиденциальная локальная обработка файлов прямо в браузере." },
  uk: { convert: "Конвертувати", compress: "Стиснути", merge: "Об'єднати", split: "Розділити", rotate: "Повернути", crop: "Обрізати", resize: "Змінити розмір", extract: "Витягти", to: "в", from: "з", onlineFree: "Безкоштовно Онлайн", privacyNotice: "Конфіденційна локальна обробка файлів безпосередньо в браузері." },
  lv: { convert: "Konvertēt", compress: "Saspiest", merge: "Apvienot", split: "Sadalīt", rotate: "Pagriezt", crop: "Apgriezt", resize: "Mainīt izmēru", extract: "Izvilkt", to: "uz", from: "no", onlineFree: "Bezmaksas Tiešsaistē", privacyNotice: "Privāta, lokāla failu apstrāde tieši jūsu pārlūkprogrammā." },
  lt: { convert: "Konvertuoti", compress: "Glaudinti", merge: "Sujungti", split: "Padalinti", rotate: "Pasukti", crop: "Apkarpyti", resize: "Keisti dydį", extract: "Išskleisti", to: "į", from: "iš", onlineFree: "Nemokamai Internete", privacyNotice: "Privatus, vietinis failų apdorojimas tiesiogiai jūsų naršyklėje." },
  tr: { convert: "Dönüştür", compress: "Sıkıştır", merge: "Birleştir", split: "Böl", rotate: "Döndür", crop: "Kırp", resize: "Yeniden Boyutlandır", extract: "Ayıkla", to: "→", from: "-", onlineFree: "Ücretsiz Çevrimiçi", privacyNotice: "Doğrudan tarayıcınızda gizli ve yerel dosya işleme." },
  ar: { convert: "تحويل", compress: "ضغط", merge: "دمج", split: "تقسيم", rotate: "تدوير", crop: "قص", resize: "تغيير الحجم", extract: "استخراج", to: "إلى", from: "من", onlineFree: "مجاناً أونلاين", privacyNotice: "معالجة ملفات خاصة ومحلية مباشرة داخل متصفحك." },
  he: { convert: "המרת", compress: "דחיסת", merge: "מיזוג", split: "פיצול", rotate: "סיבוב", crop: "חיתוך", resize: "שינוי גודל", extract: "חילוץ", to: "ל-", from: "מ-", onlineFree: "בחינם אונליין", privacyNotice: "עיבוד קבצים פרטי ומקומי ישירות בדפדפן שלך." },
  hi: { convert: "कन्वर्ट करें", compress: "कंप्रेस करें", merge: "मर्ज करें", split: "विभाजित करें", rotate: "रोटेट करें", crop: "क्रॉप करें", resize: "रीसाइज़ करें", extract: "निकालें", to: "से", from: "को", onlineFree: "मुफ़्त ऑनलाइन", privacyNotice: "सीधे आपके ब्राउज़र में निजी और स्थानीय फ़ाइल प्रोसेसिंग।" },
  id: { convert: "Konversi", compress: "Kompres", merge: "Gabungkan", split: "Pisahkan", rotate: "Putar", crop: "Pangkas", resize: "Ubah Ukuran", extract: "Ekstrak", to: "ke", from: "dari", onlineFree: "Gratis Online", privacyNotice: "Pemrosesan file pribadi dan lokal langsung di browser Anda." },
  ms: { convert: "Tukar", compress: "Mampatkan", merge: "Gabungkan", split: "Pisahkan", rotate: "Putar", crop: "Pangkas", resize: "Ubah Saiz", extract: "Ekstrak", to: "ke", from: "daripada", onlineFree: "Percuma Dalam Talian", privacyNotice: "Pemprosesan fail peribadi dan tempatan terus dalam pelayar anda." },
  th: { convert: "แปลงไฟล์", compress: "บีบอัด", merge: "รวมไฟล์", split: "แยกไฟล์", rotate: "หมุน", crop: "ครอบตัด", resize: "ปรับขนาด", extract: "แยกข้อมูล", to: "เป็น", from: "จาก", onlineFree: "ฟรีออนไลน์", privacyNotice: "ประมวลผลไฟล์อย่างเป็นส่วนตัวในเครื่องผ่านเบราว์เซอร์ของคุณ" },
  vi: { convert: "Chuyển đổi", compress: "Nén", merge: "Ghép", split: "Tách", rotate: "Xoay", crop: "Cắt", resize: "Đổi kích thước", extract: "Trích xuất", to: "sang", from: "từ", onlineFree: "Miễn phí Trực tuyến", privacyNotice: "Xử lý tệp riêng tư, cục bộ ngay trên trình duyệt của bạn." },
  fil: { convert: "I-convert ang", compress: "I-compress ang", merge: "Pagsamahin ang", split: "Hatiin ang", rotate: "Iikot ang", crop: "I-crop ang", resize: "Baguhin ang laki ng", extract: "I-extract ang", to: "sa", from: "mula sa", onlineFree: "Libre Online", privacyNotice: "Pribado at lokal na pagproseso ng file sa iyong browser." },
  ja: { convert: "変換", compress: "圧縮", merge: "結合", split: "分割", rotate: "回転", crop: "切り抜き", resize: "リサイズ", extract: "抽出", to: "から", from: "へ", onlineFree: "無料オンライン", privacyNotice: "ブラウザ内で完結する安全でプライベートなローカル処理。" },
  ko: { convert: "변환", compress: "압축", merge: "병합", split: "분할", rotate: "회전", crop: "자르기", resize: "크기 조정", extract: "추출", to: "에서", from: "으로", onlineFree: "무료 온라인", privacyNotice: "브라우저 내에서 안전하게 이루어지는 비공개 로컬 처리." },
  "zh-CN": { convert: "转换", compress: "压缩", merge: "合并", split: "拆分", rotate: "旋转", crop: "裁剪", resize: "调整大小", extract: "提取", to: "转", from: "从", onlineFree: "在线免费", privacyNotice: "完全在您的浏览器中进行的私密本地文件处理。" },
  "zh-TW": { convert: "轉換", compress: "壓縮", merge: "合併", split: "分割", rotate: "旋轉", crop: "裁切", resize: "調整大小", extract: "擷取", to: "轉", from: "從", onlineFree: "線上免費", privacyNotice: "完全在您的瀏覽器中進行的私密本機檔案處理。" }
};
...
export function getLocalizedToolMeta(
  ...
  "/change-video-speed": {
    "en": "Change Video Speed Online Free",
    "es": "Cambiar velocidad de video Online Gratis",
    "es-419": "Cambiar velocidad de video Gratis en Línea",
    "de": "Videogeschwindigkeit ändern Kostenlos Online",
    "fr": "Modifier la vitesse de la vidéo Gratuit en Ligne",
    "pt": "Mudar velocidade do vídeo Grátis Online",
    "pt-BR": "Mudar velocidade do vídeo Grátis Online",
    "it": "Modifica velocità video Gratis Online",
    "nl": "Videosnelheid wijzigen Gratis Online",
    "ca": "Canviar la velocitat del vídeo Online Gratuït",
    "sv": "Ändra videohastighet Gratis Online",
    "da": "Skift videohastighed Gratis Online",
    "fi": "Muuta videon nopeutta Ilmaiseksi Verkossa",
    "no": "Endre videohastighet Gratis på Nett",
    "pl": "Zmień prędkość wideo Za Darmo Online",
    "cs": "Změnit rychlost videa Zdarma Online",
    "hu": "Videó sebességének módosítása Ingyen Online",
    "ro": "Modifică viteza videoclipului Gratuit Online",
    "bg": "Промяна на скоростта на видеото Безплатно Онлайн",
    "el": "Αλλαγή ταχύτητας βίντεο Δωρεάν Online",
    "sk": "Zmeniť rýchlosť videa Zadarmo Online",
    "sl": "Spremeni hitrost videa Brezplačno na Spletu",
    "ru": "Изменить скорость видео Бесплатно Онлайн",
    "uk": "Змінити швидкість відео Безкоштовно Онлайн",
    "lv": "Mainīt video ātrumu Bezmaksas Tiešsaistē",
    "lt": "Keisti vaizdo įrašo greitį Nemokamai Internete",
    "tr": "Video Hızını Değiştir Ücretsiz Çevrimiçi",
    "ar": "تغيير سرعة الفيديو مجاناً أونلاين",
    "he": "שינוי מהירות וידאו בחינם אונליין",
    "hi": "वीडियो स्पीड बदलें मुफ़्त ऑनलाइन",
    "id": "Ubah Kecepatan Video Gratis Online",
    "ms": "Ubah Kelajuan Video Percuma Dalam Talian",
    "th": "ปรับความเร็ววิดีโอ ฟรีออนไลน์",
    "vi": "Thay đổi tốc độ video Miễn phí Trực tuyến",
    "fil": "Baguhin ang Bilis ng Video Libre Online",
    "ja": "動画の再生速度を変更 無料オンライン",
    "ko": "비디오 재생 속도 변경 무료 온라인",
    "zh-CN": "调整视频播放速度 在线免费",
    "zh-TW": "調整影片播放速度 線上免費"
  },
  "/compress-pdf-to-2mb": {
