...
export const CONVERSION_CATALOG: Record<string, ConversionCatalogEntry> = {
  ...
  "/mov-to-mp4": {
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple QuickTime MOV videos to universal MP4 format with high fidelity."
  },
  "/mkv-to-mp4": {
    slug: "/mkv-to-mp4",
    inputFormat: "MKV",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Remuxes and converts Matroska MKV video files into web-standard MP4 format."
  },
  "/change-video-speed": {
    slug: "/change-video-speed",
    inputFormat: "Video (MP4/WebM/MOV)",
    outputFormat: "Speed-Adjusted Video",
    family: "media",
    engineId: "shared-video-engine-v1",
    processingMode: "local",
    implementationStatus: "PRODUCTION_FROZEN",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Accelerates or slows down video playback speeds from 0.5x to 2.0x."
  },
  "/rotate-video": {
    slug: "/rotate-video",
    inputFormat: "Video (MP4/WebM/MOV)",
    outputFormat: "Rotated Video",
    family: "media",
    engineId: "shared-video-engine-v1",
    processingMode: "local",
    implementationStatus: "PRODUCTION_FROZEN",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Rotates video orientation 90 degrees clockwise, 180 degrees, or 270 degrees."
  },
  "/wav-to-mp3": {
    slug: "/wav-to-mp3",
    inputFormat: "WAV",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Compresses uncompressed PCM WAV audio tracks into lightweight MP3 audio."
  },
  "/boost-audio-volume": {
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Amplifies audio volume up to 300% louder with built-in soft-knee distortion protection."
  },
  "/pages-to-pdf": {
    slug: "/pages-to-pdf",
    inputFormat: "PAGES",
    outputFormat: "PDF",
    family: "office-to-pdf",
    engineId: "cloudflare-libreoffice-v1",
    processingMode: "server",
    implementationStatus: "PRODUCTION_FROZEN",
    indexabilityStatus: "INDEXABLE",
    navigationEnabled: true,
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple Pages (.pages) documents into universal, high-quality vector PDF files."
  },
  "/pages-to-word": {
    slug: "/pages-to-word",
    inputFormat: "PAGES",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple Pages (.pages) documents into editable Microsoft Word (.docx) files."
  },
  "/numbers-to-excel": {
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple Numbers (.numbers) spreadsheets into Microsoft Excel (.xlsx) workbooks."
  },
  "/keynote-to-pdf": {
    slug: "/keynote-to-pdf",
    inputFormat: "KEY",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple Keynote (.key) slide presentations into high-resolution PDF documents."
  },
  "/rar-to-zip": {
    slug: "/rar-to-zip",
    inputFormat: "RAR",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts WinRAR (.rar) archives into standard ZIP files online in your browser."
  },
  "/extract-rar": {
    slug: "/extract-rar",
    inputFormat: "RAR",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Unpacks and extracts files from WinRAR (.rar) archives online with zero server uploads."
  },
  "/7z-to-zip": {
    slug: "/7z-to-zip",
    inputFormat: "7Z",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts 7-Zip (.7z) compressed archives into standard ZIP format in your browser."
  },
  "/m4a-to-mp3": {
    slug: "/m4a-to-mp3",
    inputFormat: "M4A",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Apple M4A and Voice Memos into universal MP3 audio files."
  },
  "/flac-to-mp3": {
    slug: "/flac-to-mp3",
    inputFormat: "FLAC",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Transcodes lossless FLAC audio files into high-bitrate MP3 audio."
  },
  "/ogg-to-mp3": {
    slug: "/ogg-to-mp3",
    inputFormat: "OGG",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Ogg Vorbis and Opus gaming audio clips into standard MP3 format."
  },
  "/avi-to-mp4": {
    slug: "/avi-to-mp4",
    inputFormat: "AVI",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts legacy Audio Video Interleave (.avi) video files to universal MP4 format."
  },
  "/webm-to-mp4": {
    slug: "/webm-to-mp4",
    inputFormat: "WEBM",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts WebM browser video captures and HTML5 video clips to standard MP4."
  },
  "/wmv-to-mp4": {
    slug: "/wmv-to-mp4",
    inputFormat: "WMV",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Windows Media Video (.wmv) clips to modern universal MP4 video format."
  },
  "/mp4-to-wav": {
    slug: "/mp4-to-wav",
    inputFormat: "MP4",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Extracts uncompressed, studio-quality PCM WAV audio directly from MP4 video files."
  },
  "/dwg-to-pdf": {
    slug: "/dwg-to-pdf",
    inputFormat: "DWG",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts AutoCAD DWG blueprints into high-resolution vector PDF documents."
  },
  "/dxf-to-pdf": {
    slug: "/dxf-to-pdf",
    inputFormat: "DXF",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts AutoCAD Drawing Exchange Format (DXF) files into universal vector PDF documents."
  },
  "/dwg-to-dxf": {
    slug: "/dwg-to-dxf",
    inputFormat: "DWG",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts proprietary AutoCAD DWG drawings into open CAD standard DXF format."
  },
  "/eps-to-pdf": {
    slug: "/eps-to-pdf",
    inputFormat: "EPS",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Encapsulated PostScript (EPS) vector artwork into clean, scalable vector PDF files."
  },
  "/eps-to-png": {
    slug: "/eps-to-png",
    inputFormat: "EPS",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Renders Encapsulated PostScript (EPS) vector artwork into high-resolution transparent PNG images."
  },
  "/psd-to-png": {
    slug: "/psd-to-png",
    inputFormat: "PSD",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Flattens Adobe Photoshop (PSD) design documents into web-ready transparent PNG images."
  },
  "/ai-to-pdf": {
    slug: "/ai-to-pdf",
    inputFormat: "AI",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts Adobe Illustrator (AI) artwork into universal, high-quality vector PDF documents."
  },
  "/ai-to-png": {
    slug: "/ai-to-png",
    inputFormat: "AI",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Renders Adobe Illustrator (AI) vector artwork into high-resolution transparent PNG graphics."
  },
  "/srt-to-vtt": {
    slug: "/srt-to-vtt",
    inputFormat: "SRT",
    outputFormat: "VTT",
    family: "media",
    engineId: "shared-subtitle-engine-v1",
    processingMode: "local",
    implementationStatus: "PRODUCTION_FROZEN",
    indexabilityStatus: "INDEXABLE",
    navigationEnabled: true,
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts SubRip (.srt) subtitle files to WebVTT (.vtt) format for HTML5 video players."
  },
  "/vtt-to-srt": {
    slug: "/vtt-to-srt",
    inputFormat: "VTT",
    ...
    sitemapEnabled: true,
    localizationEnabled: true,
    uniqueOutcomeDefinition: "Converts WebVTT (.vtt) closed captions back to universal SubRip (.srt) subtitle format."
  }
};
