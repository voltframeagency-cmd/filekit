...
export const fileKitAssets = {
  ...
  'pdf-to-png': {
    path: '/brand-assets/conversions/pdf-to-png.svg',
    alt: 'Convert PDF pages to PNG images',
    category: 'conversion',
    viewBox: '0 0 240 160',
  },
  'pdf-to-image': {
    path: '/brand-assets/conversions/pdf-to-image.svg',
    alt: 'Convert PDF pages to images',
    category: 'conversion',
    viewBox: '0 0 240 160',
  },
  'image-to-pdf': {
  ...
  'step-2-convert': {
    path: '/brand-assets/how-it-works/convert-step-2.svg',
    alt: '2. Select Output Format illustration',
    category: 'how-it-works',
    viewBox: '0 0 451.97 330.33',
  },
  'step-2-compress': {
    path: '/brand-assets/how-it-works/compress-step-2.svg',
    alt: '2. Adjust Compression illustration',
    category: 'how-it-works',
    viewBox: '0 0 451.97 330.33',
  },
  'step-3-download': {
    path: '/brand-assets/how-it-works/image-step-3.svg',
    alt: '3. Save Converted Image illustration',
    category: 'how-it-works',
    viewBox: '0 0 451.97 330.33',
  },
  'step-download': {
