...
const translations: Partial<Record<Language, Record<string, string>>> = {
  ...
  en: {
    ...
    "paywall.single.title": "Team Plan",
    "paywall.single.billing": "Renews monthly",
    "paywall.single.tagline": "Shared team workspace and pooled processing.",
    "paywall.pass.title": "Job Pass (7 Days)",
    "paywall.pass.billing": "Never renews · One-time",
    "paywall.pass.tagline": "7 days of premium processing. Zero recurring charges.",
    "paywall.pass.badge": "Best value",
    "paywall.pro.title": "Pro Monthly",
    "paywall.pro.billing": "Renews monthly",
    "paywall.pro.tagline": "Cancel anytime before next billing date.",
  ...
  it: {
    ...
    "nav.resize": "Ridimensiona",
    "nav.pricing": "Prezzi",
    "nav.searchPlaceholder": "Cerca tra oltre 100 strumenti...",
    "nav.allToolsBtn": "Tutti gli strumenti",
    
    "hero.tagline": "File a modo tuo.",
    "hero.title1": "Trasforma i tuoi file in quello",
    "hero.title2": "che ti serve davvero.",
    "hero.subtitle1": "Converti, comprimi, ridimensiona, organizza e ripara PDF, immagini, documenti Office, audio e video.",
    "hero.subtitle2": "Elaborazione 100% privata e sicura direttamente nel tuo browser, senza caricamenti sui server.",
    
    "trust.badge1": "Elaborazione nel browser",
    "trust.badge2": "Cancellazione automatica sui server",
    "trust.badge3": "Nessun account richiesto",
    "trust.badge4": "100% Privato & Sicuro",
    
    "homepage.searchPlaceholder": "Trova lo strumento giusto per la tua attività...",
    "homepage.privateTitle": "Privacy fin dall'origine",
    "homepage.privateDesc": "I tuoi file restano con te",
    "homepage.localTitle": "Elaborato localmente",
    "homepage.localDesc": "Direttamente nel tuo browser",
    "homepage.fallbackTitle": "Backup sicuro",
    "homepage.fallbackDesc": "Trasferimento protetto da TLS",
    "homepage.dropAnywhere": "Trascina un file qui",
    "homepage.chooseFile": "Scegli File",
    "homepage.orChoose": "o seleziona un file dal tuo dispositivo",
    "homepage.methodShown": "Il metodo di elaborazione viene indicato prima di iniziare.",
    ...
    "tool.merge.desc": "Combina più file PDF",
    "tool.split.title": "Dividi PDF",
    "tool.split.desc": "Estrai e separa pagine PDF",
    "tool.rotate.title": "Ruota PDF",
    "tool.rotate.desc": "Regola l'orientamento delle pagine",
    "tool.watermark.title": "Filigrana PDF",
    "tool.watermark.desc": "Aggiungi testo o immagine",
    "tool.resize.title": "Ridimensiona Immagine",
    "tool.resize.desc": "Pixel esatti o dimensioni in KB",
    "tool.convert.title": "Convertitore Immagini",
    "tool.convert.desc": "JPG, PNG, WebP",
    "tool.pdfToWord.title": "PDF in Word",
    "tool.pdfToWord.desc": "Documento DOCX modificabile",
    "tool.allTools.title": "Tutti gli strumenti",
    "tool.allTools.desc": "Esplora il catalogo completo",

    "breadcrumb.home": "Home",
    "breadcrumb.compress": "Comprimi PDF",
    "compress.title": "Comprimi PDF a meno di 2 MB",
    "compress.subtitle": "Riduci le dimensioni del tuo PDF mantenendo la massima qualità possibile.",
    
    "badge.local": "Elaborato su questo dispositivo",
    "workspace.dropHere": "Trascina il tuo documento PDF qui",
    "workspace.pdfOnly": "Solo PDF · Elaborazione 100% locale nel browser",
    "workspace.stayOnDevice": "Il tuo file non lascia mai questo dispositivo.",
    "workspace.askBeforeTransfer": "FileKit chiederà l'autorizzazione prima di qualsiasi trasferimento temporaneo.",
    
    "trust.privateTitle": "100% Privato",
    "trust.privateDesc1": "I tuoi file restano sotto",
    "trust.privateDesc2": "il tuo totale controllo.",
    "trust.localTitle": "Priorità Locale",
    "trust.localDesc1": "Elaborazione sicura direttamente",
    "trust.localDesc2": "nel tuo browser.",
    "trust.tempTitle": "Solo Temporaneo",
    "trust.tempDesc1": "I file sui server scadono",
    "trust.tempDesc2": "automaticamente.",
    "trust.trialTitle": "Nessun Costo Nascosto",
    "trust.trialDesc1": "Condizioni trasparenti per",
    "trust.trialDesc2": "pagamento singolo o mensile.",
    
    "workspace.troubleText": "Problemi? L'elaborazione temporanea su server sicuro avviene solo previo tuo consenso.",
    "workspace.targetSize": "Dimensione desiderata",
    "workspace.recommended": "Meno di 2 MB (Consigliato)",
    "workspace.qualityNote": "Ridurremo la dimensione del file preservando la massima nitidezza.",
    "workspace.compressBtn": "Comprimi PDF",
    "workspace.localReady": "Elaborazione locale pronta.",
    "workspace.notLeftDevice": "Il tuo file non ha lasciato questo dispositivo.",
    "workspace.selectFile": "Seleziona File PDF",
    "workspace.remove": "Rimuovi",
    
    "paywall.title": "Sblocca Download",
    "paywall.subtitle": "Il file è stato elaborato con successo. Scegli un piano per scaricare.",
    "paywall.resultVerified": "Risultato Verificato",
    "paywall.fileLabel": "Nome Documento",
    "paywall.originalLabel": "Dimensione Originale",
    "paywall.outputLabel": "Nuova Dimensione",
    "paywall.changeLabel": "Riduzione Dimensione",
    "paywall.pagesLabel": "Pagine",
    "paywall.locationLabel": "Luogo di Elaborazione",
    "paywall.localLocation": "Locale (Sul dispositivo)",
    "paywall.serverLocation": "Server (Cloud)",
    "paywall.tlsGuarantee": "Crittografia in transito TLS",
    "paywall.single.title": "Esportazione Singola Premium",
    "paywall.single.billing": "Nessun rinnovo",
    "paywall.single.tagline": "Un solo file. Un solo pagamento. Nessun abbonamento.",
    "paywall.pass.title": "Pass 24 Ore",
    "paywall.pass.billing": "Nessun rinnovo",
    "paywall.pass.tagline": "Include 10 crediti server.",
    "paywall.pass.badge": "Più conveniente",
    "paywall.pro.title": "Pro Mensile",
    "paywall.pro.billing": "Rinnovo mensile",
    "paywall.pro.tagline": "Cancella in qualsiasi momento prima della fatturazione.",
    "paywall.ctaUnlock": "Sblocca Download",
    "paywall.ctaSelect": "Scegli Piano per Scaricare",
    "paywall.pending": "Creazione pagamento sicuro...",
    "paywall.cancel": "Torna al Risultato",
    "paywall.viewDetails": "Visualizza dettagli di verifica",
    "paywall.localTrust": "Elaborato in totale riservatezza su questo dispositivo",
    "paywall.localTrustSub": "Nessun caricamento file necessario",
    "paywall.serverTrust": "Crittografato in transito con TLS",
    "paywall.serverTrustSub": "Elaborato in ambiente isolato",
    "paywall.checkoutSecure": "Il pagamento sicuro utilizza connessioni crittografate",
  ...
  nl: {
    ...
    "nav.image": "Afbeeldingen",
    "nav.organize": "Organiseren",
    "nav.resize": "Formaat wijzigen",
    "nav.pricing": "Prijzen",
    "nav.searchPlaceholder": "Zoek in meer dan 100 tools...",
    "nav.allToolsBtn": "Alle tools",
    
    "hero.tagline": "Bestanden op jouw manier.",
    "hero.title1": "Verander bestanden in wat je",
    "hero.title2": "echt nodig hebt.",
    "hero.subtitle1": "Converteer, comprimeer, schaal, organiseer en herstel PDF's, afbeeldingen, Office-documenten, audio en video.",
    "hero.subtitle2": "100% privé en veilige verwerking direct in je browser, zonder uploads naar servers.",
    
    "trust.badge1": "Verwerking in de browser",
    "trust.badge2": "Automatische serververwijdering",
    "trust.badge3": "Geen account nodig",
    "trust.badge4": "100% Privé & Veilig",
    
    "homepage.searchPlaceholder": "Vind de juiste tool voor jouw taak...",
    "homepage.privateTitle": "Privacy als standaard",
    "homepage.privateDesc": "Jouw bestanden blijven bij jou",
    "homepage.localTitle": "Lokaal verwerkt",
    "homepage.localDesc": "Direct in je browser",
    "homepage.fallbackTitle": "Veilige back-up",
    "homepage.fallbackDesc": "TLS-beveiligde overdracht",
    "homepage.dropAnywhere": "Sleep een bestand hierheen",
    "homepage.chooseFile": "Bestand Kiezen",
    "homepage.orChoose": "of kies een bestand van je apparaat",
    "homepage.methodShown": "Verwerkingsmethode wordt vooraf getoond.",
    ...
    "tool.merge.desc": "Combineer meerdere PDF-bestanden",
    "tool.split.title": "PDF Splitsen",
    "tool.split.desc": "Extraheer en scheid PDF-pagina's",
    "tool.rotate.title": "PDF Draaien",
    "tool.rotate.desc": "Pas pagina-oriëntatie aan",
    "tool.watermark.title": "PDF Watermerk",
    "tool.watermark.desc": "Voeg tekst of afbeelding toe",
    "tool.resize.title": "Afbeelding Schalen",
    "tool.resize.desc": "Exacte pixels of grootte in KB",
    "tool.convert.title": "Afbeelding Converter",
    "tool.convert.desc": "JPG, PNG, WebP",
    "tool.pdfToWord.title": "PDF naar Word",
    "tool.pdfToWord.desc": "Bewerkbaar DOCX-document",
    "tool.allTools.title": "Alle tools",
    "tool.allTools.desc": "Verken de volledige catalogus",

    "breadcrumb.home": "Home",
    "breadcrumb.compress": "PDF Comprimeren",
    "compress.title": "PDF comprimeren tot onder 2 MB",
    "compress.subtitle": "Verklein je PDF-bestand met behoud van de hoogste kwaliteit.",
    
    "badge.local": "Verwerkt op dit apparaat",
    "workspace.dropHere": "Sleep je PDF-document hierheen",
    "workspace.pdfOnly": "Alleen PDF · 100% lokale verwerking in de browser",
    "workspace.stayOnDevice": "Je bestand verlaat dit apparaat nooit.",
    "workspace.askBeforeTransfer": "FileKit vraagt toestemming voor elke tijdelijke overdracht.",
    
    "trust.privateTitle": "100% Privé",
    "trust.privateDesc1": "Jouw bestanden blijven onder",
    "trust.privateDesc2": "jouw volledige controle.",
    "trust.localTitle": "Lokale Prioriteit",
    "trust.localDesc1": "Veilige verwerking direct",
    "trust.localDesc2": "in je browser.",
    "trust.tempTitle": "Alleen Tijdelijk",
    "trust.tempDesc1": "Serverbestanden verlopen",
    "trust.tempDesc2": "automatisch.",
    "trust.trialTitle": "Geen Verborgen Kosten",
    "trust.trialDesc1": "Duidelijke voorwaarden voor",
    "trust.trialDesc2": "eenmalige of maandelijkse betaling.",
    
    "workspace.troubleText": "Problemen? Tijdelijke verwerking op een beveiligde server gebeurt alleen met jouw toestemming.",
    "workspace.targetSize": "Gewenste grootte",
    "workspace.recommended": "Minder dan 2 MB (Aanbevolen)",
    "workspace.qualityNote": "We verkleinen het bestand met behoud van maximale scherpte.",
    "workspace.compressBtn": "PDF Comprimeren",
    "workspace.localReady": "Lokale verwerking gereed.",
    "workspace.notLeftDevice": "Je bestand heeft dit apparaat niet verlaten.",
    "workspace.selectFile": "Selecteer PDF-bestand",
    "workspace.remove": "Verwijderen",
    
    "paywall.title": "Download Ontgrendelen",
    "paywall.subtitle": "Bestand succesvol verwerkt. Kies een optie om te downloaden.",
    "paywall.resultVerified": "Resultaat Geverifieerd",
    "paywall.fileLabel": "Documentnaam",
    "paywall.originalLabel": "Oorspronkelijke Grootte",
    "paywall.outputLabel": "Nieuwe Grootte",
    "paywall.changeLabel": "Groottevermindering",
    "paywall.pagesLabel": "Pagina's",
    "paywall.locationLabel": "Verwerkingslocatie",
    "paywall.localLocation": "Lokaal (Op apparaat)",
    "paywall.serverLocation": "Server (Cloud)",
    "paywall.tlsGuarantee": "TLS-gecodeerde overdracht",
    "paywall.single.title": "Individuele Premium Export",
    "paywall.single.billing": "Geen verlenging",
    "paywall.single.tagline": "Eén bestand. Eén betaling. Geen abonnement.",
    "paywall.pass.title": "24-Uurs Pas",
    "paywall.pass.billing": "Geen verlenging",
    "paywall.pass.tagline": "Inclusief 10 servercredits.",
    "paywall.pass.badge": "Meest gekozen",
    "paywall.pro.title": "Pro Maandelijks",
    "paywall.pro.billing": "Maandelijkse verlenging",
    "paywall.pro.tagline": "Annuleer op elk gewenst moment vóór de volgende factuurdatum.",
    "paywall.ctaUnlock": "Download Ontgrendelen",
    "paywall.ctaSelect": "Kies Plan om te Downloaden",
    "paywall.pending": "Beveiligde betaling voorbereiden...",
    "paywall.cancel": "Terug naar Resultaat",
    "paywall.viewDetails": "Verificatiedetails bekijken",
    "paywall.localTrust": "In volledige privacy verwerkt op dit apparaat",
    "paywall.localTrustSub": "Geen bestandsupload nodig",
    "paywall.serverTrust": "Gecodeerd in overdracht met TLS",
    "paywall.serverTrustSub": "Verwerkt in een geïsoleerde sandbox",
    "paywall.checkoutSecure": "Beveiligde betaling via versleutelde verbindingen",
  ...
  ca: {
    "nav.allTools": "Totes les eines",
    "nav.compress": "Comprimir",
    "nav.convert": "Convertir",
    "nav.merge": "Unir",
    "nav.image": "Imatges",
    "nav.organize": "Organitzar",
    "nav.resize": "Canviar mida",
    "nav.pricing": "Preus",
    "nav.searchPlaceholder": "Cerca entre més de 100 eines...",
    "nav.allToolsBtn": "Totes les eines",
    
    "hero.tagline": "Fitxers a la teva manera.",
    "hero.title1": "Transforma els teus fitxers en allò",
    "hero.title2": "que realment necessites.",
    "hero.subtitle1": "Converteix, comprimeix, canvia la mida, organitza i repara PDF, imatges, documents d'Office, àudio i vídeo.",
    "hero.subtitle2": "Processament 100% privat i segur directament al teu navegador, sense pujades a servidors.",
    
    "trust.badge1": "Processament al navegador",
    "trust.badge2": "Eliminació automàtica al servidor",
    "trust.badge3": "Sense necessitat de compte",
    "trust.badge4": "100% Privat & Segur",
    
    "homepage.searchPlaceholder": "Troba l'eina adequada per a la teva tasca...",
    "homepage.privateTitle": "Privadesa per defecte",
    "homepage.privateDesc": "Els teus fitxers es queden amb tu",
    "homepage.localTitle": "Processat localment",
    "homepage.localDesc": "Directament al teu navegador",
    "homepage.fallbackTitle": "Còpia de seguretat segura",
    "homepage.fallbackDesc": "Transferència protegida per TLS",
    "homepage.dropAnywhere": "Arrossega un fitxer aquí",
    "homepage.chooseFile": "Triar Fitxer",
    "homepage.orChoose": "o tria un fitxer del teu dispositiu",
    "homepage.methodShown": "El mètode de processament es mostra abans de començar.",
    ...
    "tool.merge.title": "Unir PDF",
    "tool.merge.desc": "Combina múltiples fitxers PDF",
    "tool.split.title": "Dividir PDF",
    "tool.split.desc": "Extreu i separa pàgines de PDF",
    "tool.rotate.title": "Girar PDF",
    "tool.rotate.desc": "Ajusta l'orientació de les pàgines",
    "tool.watermark.title": "Marca d'Aigua en PDF",
    "tool.watermark.desc": "Afegeix text o imatge",
    "tool.resize.title": "Canviar Mida d'Imatge",
    "tool.resize.desc": "Píxels exactes o mida en KB",
    "tool.convert.title": "Convertidor d'Imatges",
    "tool.convert.desc": "JPG, PNG, WebP",
    "tool.pdfToWord.title": "PDF a Word",
    "tool.pdfToWord.desc": "Document DOCX editable",
    "tool.allTools.title": "Totes les eines",
    "tool.allTools.desc": "Explora el catàleg complet",

    "breadcrumb.home": "Inici",
    "breadcrumb.compress": "Comprimir PDF",
    "compress.title": "Comprimir PDF a menys de 2 MB",
    "compress.subtitle": "Redueix la mida del teu PDF mantenint la màxima qualitat possible.",
    
    "badge.local": "Processat en aquest dispositiu",
    "workspace.dropHere": "Arrossega el teu document PDF aquí",
    "workspace.pdfOnly": "Només PDF · Processament 100% local al navegador",
    "workspace.stayOnDevice": "El teu fitxer mai surt d'aquest dispositiu.",
    "workspace.askBeforeTransfer": "FileKit demanarà permís abans de qualsevol transferència temporal.",
    
    "trust.privateTitle": "100% Privat",
    "trust.privateDesc1": "Els teus fitxers es queden sota",
    "trust.privateDesc2": "el teu control total.",
    "trust.localTitle": "Prioritat Local",
    "trust.localDesc1": "Processament segur directament",
    "trust.localDesc2": "al teu navegador.",
    "trust.tempTitle": "Només Temporal",
    "trust.tempDesc1": "Els fitxers del servidor caduquen",
    "trust.tempDesc2": "automàticament.",
    "trust.trialTitle": "Sense Costos Ocults",
    "trust.trialDesc1": "Condicions clares per a",
    "trust.trialDesc2": "pagament únic o mensual.",
    
    "workspace.troubleText": "Problemes? El processament temporal en un servidor segur només es realitza amb el teu consentiment.",
    "workspace.targetSize": "Mida desitjada",
    "workspace.recommended": "Menys de 2 MB (Recomanat)",
    "workspace.qualityNote": "Reduirem la mida del fitxer mantenint la màxima nitidesa.",
    "workspace.compressBtn": "Comprimir PDF",
    "workspace.localReady": "Processament local llest.",
    "workspace.notLeftDevice": "El teu fitxer no ha sortit d'aquest dispositiu.",
    "workspace.selectFile": "Seleccionar Fitxer PDF",
    "workspace.remove": "Eliminar",
    
    "paywall.title": "Desbloquejar Descàrrega",
    "paywall.subtitle": "El fitxer s'ha processat correctament. Tria un pla per descarregar.",
    "paywall.resultVerified": "Resultat Verificat",
    "paywall.fileLabel": "Nom del Document",
    "paywall.originalLabel": "Mida Original",
    "paywall.outputLabel": "Nova Mida",
    "paywall.changeLabel": "Reducció de Mida",
    "paywall.pagesLabel": "Pàgines",
    "paywall.locationLabel": "Ubicació de Processament",
    "paywall.localLocation": "Local (Al dispositiu)",
    "paywall.serverLocation": "Servidor (Núvol)",
    "paywall.tlsGuarantee": "Xifratge en trànsit amb TLS",
    "paywall.single.title": "Exportació Individual Premium",
    "paywall.single.billing": "Sense renovació",
    "paywall.single.tagline": "Un sol fitxer. Un sol pagament. Sense subscripció.",
    "paywall.pass.title": "Passi de 24 Hores",
    "paywall.pass.billing": "Sense renovació",
    "paywall.pass.tagline": "Inclou 10 crèdits de servidor.",
    "paywall.pass.badge": "Més avantatjós",
    "paywall.pro.title": "Pro Mensual",
    "paywall.pro.billing": "Renovació mensual",
    "paywall.pro.tagline": "Cancel·la en qualsevol moment abans de la següent facturació.",
    "paywall.ctaUnlock": "Desbloquejar Descàrrega",
    "paywall.ctaSelect": "Triar Pla per Descarregar",
    "paywall.pending": "Creant pagament segur...",
    "paywall.cancel": "Tornar al Resultat",
    "paywall.viewDetails": "Veure detalls de verificació",
    "paywall.localTrust": "Processat amb total privadesa en aquest dispositiu",
    "paywall.localTrustSub": "No cal pujar fitxers",
    "paywall.serverTrust": "Xifrat en trànsit amb TLS",
    "paywall.serverTrustSub": "Processat en un entorn aïllat",
    "paywall.checkoutSecure": "El pagament segur utilitza connexions xifrades",
