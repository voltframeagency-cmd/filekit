...
export default function WordToPdfPage() {
  const jsonLd = {
    ...
    "@type": "WebApplication",
    "name": "FileKit Convert Word to PDF",
    "url": buildCanonicalUrl("/word-to-pdf"),
    "description": "Convert DOCX and DOC Word documents to PDF online with high-fidelity formatting.",
      ...
      <main className="flex-1 flex flex-col gap-6 md:gap-10 max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 py-6 md:py-12">
        <section className="flex flex-col gap-1.5 max-w-[840px] mx-auto w-full text-left ltr:text-left rtl:text-right px-2">
          ...
          <p className="text-[13px] md:text-[15px] font-medium text-slate-600 leading-relaxed">
            Convert Microsoft Word documents (.docx, .doc) to PDF with exact layout retention and zero data retention.
          </p>
        </section>

        <OfficeConverterWorkspace
          toolTitle="Convert Word to PDF"
          toolSlug="/word-to-pdf"
          apiEndpoint="/api/internal/convert/word-to-pdf"
          acceptedExtensions=".docx,.doc,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword"
          documentTypeLabel="Word Document"
        />
        <ToolContentRenderer operationId="word-to-pdf" />
      </main>
