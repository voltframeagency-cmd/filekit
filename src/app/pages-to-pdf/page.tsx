...
export default function PagesToPdfPage() {
  const jsonLd = {
    ...
    "@type": "WebApplication",
    "name": "Convert Apple Pages to PDF Online Free – FileKit",
    "url": buildCanonicalUrl("/pages-to-pdf"),
    "description": "Convert Apple Pages (.pages) documents into high-quality universal PDF documents online.",
    ...
    <div className="flex flex-col min-h-screen bg-fk-bg">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-8">
        <OfficeConverterWorkspace
          toolTitle="Convert Apple Pages to PDF Online"
