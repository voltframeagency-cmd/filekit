...
export default function PdfToWordPage() {
  const jsonLd = {
    ...
    "@type": "WebApplication",
    "name": "FileKit Convert PDF to Word",
    "url": buildCanonicalUrl("/pdf-to-word"),
    "description": "Convert PDF documents to editable Microsoft Word (.docx) files online with high accuracy.",
      ...
      <main className="flex-1 flex flex-col gap-6 md:gap-10 max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 py-6 md:py-12">
        <section className="flex flex-col gap-1.5 max-w-[840px] mx-auto w-full text-left ltr:text-left rtl:text-right px-2">
          ...
          <p className="text-[13px] md:text-[15px] font-medium text-blue-100 leading-relaxed">
            Convert PDF files into editable Microsoft Word documents with paragraph, heading, and table retention.
          </p>
        </section>

        <ReverseOfficeWorkspace
          toolTitle="Convert PDF to Word"
          toolSlug="/pdf-to-word"
          apiEndpoint="/api/internal/convert/pdf-to-word"
          targetFormatExtension=".docx"
          targetFormatName="Word Document (DOCX)"
          targetFormatBadge="DOCX"
        />
        <ToolContentRenderer operationId="pdf-to-word" />
      </main>
