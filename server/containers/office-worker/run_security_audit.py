...
print("==========================================")
print(f"PREVIOUS_BEARER_REJECTED = {pass1 and pass2}")
print(f"PREVIOUS_ADMIN_REJECTED = {pass3}")
print(f"CURRENT_BEARER_AUTHORIZED = {pass4}")
print(f"CURRENT_ADMIN_AUTHORIZED = {pass5}")
