...
def main():
    ...
    files_to_hash = {
        ...
        "macroIdentityJson": "macro_fixture_identity_results.json",
        "failedReproJson": "failed_fixtures_reproduction_results.json",
        "retryAuditJson": "24job_retry_accounting_audit.json",
        "coldWarmTimingJson": "12job_cold_warm_timing_results.json",
